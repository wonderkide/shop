<?php
use yii\web\View;
$this->registerCssFile(Yii::$app->assetManager->getPublishedUrl('@MDAsset')."/css/flexslider1.css", [
    'depends' => [\yii\bootstrap\BootstrapAsset::className(), frontend\assets\MDAsset::className()],'media' => 'screen',]);
$this->registerJsFile(
    Yii::$app->assetManager->getPublishedUrl('@MDAsset').'/js/imagezoom.js',
    ['depends' => [\yii\web\JqueryAsset::className(),frontend\assets\MDAsset::className()]]
);
/*$this->registerJsFile(
    Yii::$app->assetManager->getPublishedUrl('@MDAsset').'/js/simpleCart.min.js',
    ['depends' => [\yii\web\JqueryAsset::className(),frontend\assets\MDAsset::className()]]
);*/
...
<div class="breadcrumbs">
        <div class="container">
                <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                        ...
                        <li class="active">Product Detail (<?= $model->name ?>)</li>
                </ol>
        </div>
</div>
<!--//breadcrumbs-->
                ...
                <div class="single-info">		
                        <div class="col-md-6 single-top wow fadeInLeft animated" data-wow-delay=".5s">	
                                <div class="flexslider">
                                        <ul class="slides">
                                            <?php foreach ($img as $rimg): ?>
                                                <li data-thumb="<?= str_replace("products","products/thumbnails",$rimg) ?>">
                                                   <div class="thumb-image"> <img src="<?= $rimg ?>" data-imagezoom="true" class="img-responsive" alt=""> </div>
                                                </li> 
                                            <?php endforeach; ?>
                                        </ul>
                                </div>
                        ...
                        <div class="col-md-6 single-top-left simpleCart_shelfItem wow fadeInRight animated" data-wow-delay=".5s">
                                <h3><?= $model->name ?></h3>
                                <p class="item_pid hidden"><?= $model->id ?></p>
                                <p class="item_name hidden"><?= $model->name ?></p>
                                <p class="item_image hidden"><?= $img[0] ?></p>
                                ...
                                <h6 class="item_price">$<?= $model->price ?></h6>
                                ...
                                <ul class="color">
                                        <h4>Color</h4>
                                        <?php
                                        foreach ($detail as $key => $rcolor):
                                        ?>
                                        <li><a href="?color=<?= str_replace("#", "", $rcolor->color) ?>" class="<?= $rcolor->color ?>">
                                                <?php
                                                if($rcolor->color == $color){
                                ...
                                <p class="hidden"><span class="item_color"><?= $color ?></span></p>
                                <?php else: ?>
                                <p class="hidden"><span class="item_color">-</span></p>
                                <?php endif; ?>
                                ...
                                <ul class="size">
                                        ...
                                        <?php
                                        $allSize = [];
                                        foreach ($size as $key => $srow):
                                            $allSize[$srow->size] = $srow->size;
                                        endforeach;
                                        echo Select2::widget([
                                            'name' => 'p_size',
                                            'hideSearch' => true,
                                            'data' => $allSize,
                                            'options' => ['id' => 'detail-selected-size'],
                                            'pluginOptions' => [
                                                'allowClear' => FALSE
                                            ],
                                        ]);
                                ...
                                <p class="hidden"><span id="detail-item-size" class="item_size"><?= $size[0]->size ?></span></p>
                                <?php else: ?>
                                <p class="hidden"><span class="item_size">-</span></p>
                                <?php endif; ?>
                                
                                <div class="clearfix"> </div>
                                <div class="quantity">
                                        <p class="qty"> Qty :  </p><input min="1" max="1" type="number" value="1" class="item_quantity">
                                </div>
                                <div class="btn_form">
                ...
                <div class="related-products">
                        ...
                        <div class="related-products-info">
                                ...
                                <div class="col-md-3 new-grid new-mdl simpleCart_shelfItem wow flipInY animated" data-wow-delay=".7s">
                                        <div class="new-top">
                                                <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g10.jpg" class="img-responsive" alt=""/></a>
                                                <div class="new-text">
                                                        <ul>
                                                                <li><a class="item_add" href=""> Add to cart</a></li>
                                                                <li><a href="single.html">Quick View </a></li>
                                ...
                                <div class="col-md-3 new-grid new-mdl1 simpleCart_shelfItem wow flipInY animated" data-wow-delay=".9s">
                                        <div class="new-top">
                                                <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g11.jpg" class="img-responsive" alt=""/></a>
                                                <div class="new-text">
                                                        <ul>
                                                                <li><a class="item_add" href=""> Add to cart</a></li>
                                                                <li><a href="single.html">Quick View </a></li>
                                ...
                                <div class="col-md-3 new-grid simpleCart_shelfItem wow flipInY animated" data-wow-delay="1.1s">
                                        <div class="new-top">
                                                <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g12.jpg" class="img-responsive" alt=""/></a>
                                                <div class="new-text">
                                                        <ul>
                                                                <li><a class="item_add" href=""> Add to cart</a></li>
                                                                <li><a href="single.html">Quick View </a></li>
...
$this->registerJs(
    ...
    $('.single-top-left ul.color li a').each(function(){
