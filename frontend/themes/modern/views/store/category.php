<?php
use yii\web\View;
$this->registerCssFile(Yii::$app->assetManager->getPublishedUrl('@MDAsset')."/css/jquery-ui.css", [
    'depends' => [\yii\bootstrap\BootstrapAsset::className(), frontend\assets\MDAsset::className()],]);
$this->registerJsFile(
    Yii::$app->assetManager->getPublishedUrl('@MDAsset').'/js/jquery-ui.js',
    ['depends' => [\yii\web\JqueryAsset::className(),frontend\assets\MDAsset::className()]]
);
$this->registerJsFile(
    Yii::$app->assetManager->getPublishedUrl('@MDAsset').'/js/jquery.jscrollpane.min.js',
    ['depends' => [\yii\web\JqueryAsset::className(),frontend\assets\MDAsset::className()]]
);
$this->registerJsFile(
    Yii::$app->assetManager->getPublishedUrl('@MDAsset').'/js/jquery.mousewheel.js',
    ['depends' => [\yii\web\JqueryAsset::className(),frontend\assets\MDAsset::className()]]
);
?>
<!--breadcrumbs-->
        ...
        <div class="container">
                <div class="col-md-9 product-model-sec">
                        ...
                        <div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".9s">
                                <div class="new-top">
                                        <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g7.jpg" class="img-responsive" alt=""/></a>
                                        <div class="new-text">
                                                <ul>
                                                        <li><a href="single.html">Quick View </a></li>
                                                        <li><input type="number" class="item_quantity" min="1" value="1"></li>
                        ...
                        <div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
                                <div class="new-top">
                                        <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g3.jpg" class="img-responsive" alt=""/></a>
                                        <div class="new-text">
                                                <ul>
                                                        <li><a href="single.html">Quick View </a></li>
                                                        <li><input type="number" class="item_quantity" min="1" value="1"></li>
                        ...
                        <div class="product-grids product-grids-mdl simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".7s">
                                <div class="new-top">
                                        <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g6.jpg" class="img-responsive" alt=""/></a>
                                        <div class="new-text">
                                                <ul>
                                                        <li><a href="single.html">Quick View </a></li>
                                                        <li><input type="number" class="item_quantity" min="1" value="1"></li>
                        ...
                        <div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".9s">
                                <div class="new-top">
                                        <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g2.jpg" class="img-responsive" alt=""/></a>
                                        <div class="new-text">
                                                <ul>
                                                        <li><a href="single.html">Quick View </a></li>
                                                        <li><input type="number" class="item_quantity" min="1" value="1"></li>
                        ...
                        <div class="product-grids simpleCart_shelfItem wow fadeInUp animated" data-wow-delay=".5s">
                                <div class="new-top">
                                        <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/g8.jpg" class="img-responsive" alt=""/></a>
                                        <div class="new-text">
                                                <ul>
                                                        <li><a href="single.html">Quick View </a></li>
                                                        <li><input type="number" class="item_quantity" min="1" value="1"></li>
                ...
                <div class="col-md-3 rsidebar">
                        ...
                        <div class="gallery-grid ">
                                ...
                                <a href="single.html"><img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/b1.png" class="img-responsive" alt=""/></a>
