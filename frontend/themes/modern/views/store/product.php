                ...
                <div class="single-info">		
                        <div class="col-md-6 single-top wow fadeInLeft animated" data-wow-delay=".5s">	
                                <div class="flexslider">
                                        <ul class="slides">
                                                <li data-thumb="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s1.jpg">
                                                        <div class="thumb-image"> <img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                                                </li>
                                                <li data-thumb="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s2.jpg">
                                                         <div class="thumb-image"> <img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s2.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                                                </li>
                                                <li data-thumb="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s3.jpg">
                                                   <div class="thumb-image"> <img src="<?= Yii::$app->assetManager->getPublishedUrl('@MDAsset') ?>/images/s3.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
                                                </li> 
                                        </ul>
                                </div>
                        </div>
