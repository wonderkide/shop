...
<nav class="navbar" role="navigation">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav top-nav-info">
                    <li><a href="<?= Url::to(["/"]); ?>" class="<?=  MenuByCategory::checkActive('store/index') ?>">Home</a></li>
                    <?php 
                    foreach ($model as $row) {
                        $parent = MenuByCategory::findParent($row->id);
                        if(!$parent){
                        ?>
                    <li><a href="<?= Url::to(["/product/category/".$row->name]); ?>" class="<?= MenuByCategory::checkActive('product/category/'.$row->name) ?>"><?= ucfirst($row->name) ?></a></li>
                        <?php
                        }else{
                        ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle <?= MenuByCategory::checkActive('product/category/'.$row->name) ?>" data-toggle="dropdown"><?= ucfirst($row->name) ?><b class="caret"></b></a>
                                            ...
                                            <div class="dropdown-new-style">
                                                ...
                                                <div class="col-sm-<?= $grid ?> menu-grids">
                                                        <ul class="multi-column-dropdown">
                                                            <li><h3><a class="list" href="<?= Url::to(["/product/category/".$row->name."?sub=".$prow->name]); ?>"><?= $prow->name ?></a></h6></li>
                                                            <!--<h4>Baby Gear</h4>-->
                                                            <li><a class="list" href="<?= Url::to(["/product/detail/".$prow->name]); ?>">Baby Walkers</a></li>
